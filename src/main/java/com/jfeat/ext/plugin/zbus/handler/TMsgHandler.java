 ...
 */
package com.jfeat.ext.plugin.zbus.handler;
 ...
 * @since V1.0.0
 */
public abstract class TMsgHandler<T> implements Consumer.ConsumerHandler {
	...
	@Override
	public final void handle(Message msg, Consumer consumer) throws IOException {
		Object obj;
		try {
